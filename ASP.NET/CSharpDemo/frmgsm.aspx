<%@ Page Language="C#" CodeBehind="frmgsm.aspx.cs" MasterPageFile="Layout.Master" Inherits="CScharpDemo.frmgsm" AutoEventWireup="true" %>

		<asp:Content runat="server" ContentPlaceHolderID="container">
            <h1>Auron SMS Component - ASP .NET C# GSM (Serverside)</h1>
			<hr />
			<p>
				...
				For more details about using SMS Component with ASP .NET, <a href="https://www.auronsoftware.com/knowledge-base/#sms-component"
