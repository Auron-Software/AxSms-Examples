<%@ Page Language="C#" MasterPageFile="Layout.Master" AutoEventWireup="true" CodeBehind="frmussd.aspx.cs" Inherits="CScharpDemo.frmussd" %>

		<asp:Content runat="server" ContentPlaceHolderID="container">
            <h1>Auron SMS Component - ASP .NET C# USSD (Serverside)</h1>
			<hr />
			<p>
			...
			<form id="form1" runat="server">
				...
				<p>
					<asp:TextBox ID="txtResponse" CssClass="FullWidth" Font-Bold="true" runat="server"></asp:TextBox>
				</p>
