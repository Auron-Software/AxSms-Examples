<%@ Page Language="vb" MasterPageFile="Layout.Master" AutoEventWireup="false" CodeBehind="frmsnpp.aspx.vb" Inherits="VisualBasicDemo.frmSnpp" %>

		<asp:Content runat="server" ContentPlaceHolderID="container">
            <h1>Auron SMS Component - ASP VB.NET Pager SNPP (Serverside)</h1>
			<hr />
			<p>
