<%@ Page Language="vb" MasterPageFile="Layout.Master" AutoEventWireup="false" CodeBehind="frmsmpp.aspx.vb" Inherits="VisualBasicDemo.frmSmpp" %>

		<asp:Content runat="server" ContentPlaceHolderID="container">
            <h1>Auron SMS Component - ASP VB.NET SMPP (Serverside)</h1>
			<hr />
			<p>
			...
			<form id="form1" runat="server">
				...
				<p>
					<asp:TextBox ID="txtMessageStatus" CssClass="FullWidth" runat="server"></asp:TextBox>
				</p>
