<%@ Page Language="vb" MasterPageFile="Layout.Master" AutoEventWireup="false" ValidateRequest="false" CodeBehind="frmhttpxml.aspx.vb" Inherits="VisualBasicDemo.frmhttpxml" %>

		<asp:Content runat="server" ContentPlaceHolderID="container">
            <h1>Auron SMS Component - ASP VB.NET HTTP XML (Serverside)</h1>
			<hr />
			<p>
