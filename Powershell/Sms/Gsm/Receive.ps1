...
$strResult = "Receive, result: " + $objGsm.LastError + " (" + $objGsm.GetErrorDescription($objGsm.LastError) + ")"
write-host $strResult
...
$strResult = "GetFirstSms: " + $objGsm.LastError + " (" + $objGsm.GetErrorDescription($objGsm.LastError) + ")"
write-host $strResult
while ($objGsm.LastError -eq 0)
{
  ...
  $strResult = "GetNextSms: " + $objGsm.LastError + " (" + $objGsm.GetErrorDescription($objGsm.LastError) + ")"
  write-host $strResult  
}
